...
while(iteration<100000):
	temp=nextprime(rand_num);
	prime_32_list.append(temp)
	rand_num = random.getrandbits(32)
	iteration=iteration+1

while(len(prime_128_list)!=1024):
	r1=random.choice(prime_32_list);
	r2=random.choice(prime_32_list);
	r3=random.choice(prime_32_list);
	r4=random.choice(prime_32_list);
	value=2*r1*r2*r3*r4+1
	if(isprime(value)):
		temp=math.log(value)/math.log(2)
		size=math.ceil(temp)
		if(size==128):
			print(r1,r2,r3,r4,value);
			prime_128_list.append(value);

prime_128_list.sort();
for i in prime_128_list:
	print(i);
